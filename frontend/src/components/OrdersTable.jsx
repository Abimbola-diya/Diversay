              ...
              return (
                ...
                >
                  ...
                  <div className="w-[22%] pt-6 px-6 pb-8 flex flex-col justify-between items-center text-center relative z-10 pl-4 h-full">
                    {/* Logo stub */}
                    <div>
                      <div className="text-2xl font-black text-white tracking-tighter flex items-center justify-center gap-1">
                        D
                        <svg width="34" height="15" viewBox="80 15 510 230" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline-block ml-0.5 align-middle">
